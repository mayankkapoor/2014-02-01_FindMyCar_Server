"""
Django settings for findmycarproject project.
...
BASE_DIR = os.path.dirname(os.path.dirname(__file__)) #directory of manage.py
...
SECRET_KEY = '%+aw_qmzzjknh*+g=^&!-+$y=d^#j4lt%vdl1^$tmt(+&*c=i3'
